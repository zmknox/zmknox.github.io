...
Here's an example from my experience: in [my 2018 WWDC scholarship submission](https://zachknox.com/2018/04/02/WWDC-scholarship-application.html), I used three pages. The first provided the main premise for the game, the second showed the problem, and the third provided solutions and some code the user could modify. Pages provide a sense of progression, while also only showing a user what they need to see at that moment.
